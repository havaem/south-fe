...
export class Sprite extends GameObject {
    ...
    constructor({
        ...
        offset, // offset from the top left corner
    ...
    drawImage(ctx: CanvasRenderingContext2D, x: number, y: number) {
        ...
        ctx.drawImage(
            this.resource.image,
            frameCoordX + this.offset.x, // Top X corner of frame
            frameCoordY + this.offset.y, // Top Y corner of frame
